# Vendored from Fannovel16/ComfyUI-Frame-Interpolation @ 26545cc2dd95bc3d27f056016300673bdeee78f5.
# MIT; see RIFE-LICENSE.txt. Local change: warp grids follow the tensor device,
# including CPU retries, instead of selecting CUDA at module import.
"""
26-Dez-21
...
def warp(tenInput, tenFlow):
    ...
    k = (str(device), str(tenFlow.dtype), str(tenFlow.size()))
